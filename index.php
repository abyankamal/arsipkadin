...
?>
  ...
  <head>
  <title>Sekertariat Kamar Dagang Dan Industri Kota Bandung</title>
    ...
    <div class="container">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">
              <center><img src="img/LOG_KADIN.jpg"><br>Sekertariat Kamar Dagang Dan Industri Kota Bandung</center>
            </h4>
          </div>
      ...
      <center>
        <font>Copyright &copy; 2024. <?php $copy = mysqli_query($konek, "select * from config");
                                      $copy1 = mysqli_fetch_array($copy);
                                      echo $copy1['copyright']; ?></font>
      </center>
    </div>
